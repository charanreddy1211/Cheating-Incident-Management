...
db_config = {
    ...
    'password': os.getenv('DB_PASSWORD', 'Nous@12345'),  # Default to 'your_password' if not set
    'database': os.getenv('DB_NAME', 'cheating_incident_db')  # Default to 'cheating_incident_db' if not set
}
